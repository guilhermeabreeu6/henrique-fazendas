...
export default function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="pulse-ring fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition duration-300 hover:scale-110"
    >
